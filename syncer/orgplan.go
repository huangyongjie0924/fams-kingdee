...
type OrgEmployee struct {
	...
	// 实测 136 名范围内人员里，112 人恰好「1201 一条 + 1202 一条」。
	DeptCodes []string
}
...
// 为什么要定这条规则：实测 136 名范围内人员里 112 人恰好「1201 一条 + 1202 一条」，
// 是同一职位在两个法人下各挂一条，其中 105 人两边同名——取哪个名字都一样。
// 但台账 employee.dept_id 是单值，必须有个确定的、可解释的选择，
// 否则同一个人两次同步可能落到不同部门。
//
// 选 1201 的理由：台账资产的 227 张卡里 140 张挂在 1201 下（1202 是 87 张），
